package com.count.CourtesyRegistrationPrimaryPhoneCheckByClient;
...
public class CourtesyRegistrationPrimaryPhoneCheckByClient_Rule_01 {
	...
	@Test
	public  void CourtesyRegistrationPrimaryPhoneCheckByClient_Rule_01() throws Exception {
		...
		.body("{\r\n" + 
				...
				"                                    \"programType\": \""+ data.program_Type_SERVICE()+"\"," + 
        ...
        if (counter == numberOfTimes) {
        	...
        	CourtesyRegistrationPrimaryPhoneCheckByClient courtesyRegistrationPrimaryPhoneCheckByClient = new CourtesyRegistrationPrimaryPhoneCheckByClient();
        	courtesyRegistrationPrimaryPhoneCheckByClient.CourtesyRegistrationPrimaryPhoneCheckByClient(serviceRequestNbr);
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			CourtesyRegistrationPrimaryPhoneCheckByClient_Rule_01();
		}
