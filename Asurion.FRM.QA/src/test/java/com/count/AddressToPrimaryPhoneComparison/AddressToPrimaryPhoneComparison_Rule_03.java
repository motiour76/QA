...
public class AddressToPrimaryPhoneComparison_Rule_03 {
	...
	@Test
	public  void AddressToPrimaryPhoneComparison_Rule_01() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	AddressToPrimaryPhoneComparison addressToConsumerComparison = new AddressToPrimaryPhoneComparison();
        	addressToConsumerComparison.AddressToPrimaryPhoneComparison(serviceRequestNbr);
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			AddressToPrimaryPhoneComparison_Rule_01();
		}
