package com.count.PrimaryPhoneByGeoIDs;
...
public class PrimaryPhoneByGeoIDs_Rule_01 {
	...
	public  void CourtesyRegistrationEmailCheckByClient_Rule_01() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	PrimaryPhoneByGeoIDs primaryPhoneByGeoIDs = new PrimaryPhoneByGeoIDs();
        	primaryPhoneByGeoIDs.PrimaryPhoneByGeoIDs(serviceRequestNbr);
