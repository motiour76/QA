package com.count.ClaimsByIPAddress;
...
import com.count.CountOfAddressesByIPaddress.CountOfAddressesByIPaddress;
import com.jayway.restassured.RestAssured;
import com.jayway.restassured.config.SSLConfig;
import com.jayway.restassured.http.ContentType;
import com.jayway.restassured.response.ValidatableResponse;

public class ClaimsByIPAddress_Rule_01 {
	...
	@Test
	public  void ClaimsByIPAddress_Rule_01() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	ClaimsByIPAddress claimsByIPAddress = new ClaimsByIPAddress();
        	claimsByIPAddress.ClaimsByIPAddress(serviceRequestNbr);
