...
public class AddressToConsumerComparision_Rule_11 {
	...
	@Test
	public  void AddressToConsumerComparision_Rule_11() throws Exception {
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			AddressToConsumerComparision_Rule_11();
		}
