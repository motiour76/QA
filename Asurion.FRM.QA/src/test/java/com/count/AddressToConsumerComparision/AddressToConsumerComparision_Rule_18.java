...
public class AddressToConsumerComparision_Rule_18 {
	
	public int counter = 0;
	public int numberOfTimes =9;
	public String serviceRequestNbr;
	
	

	@Test
	public  void AddressToConsumerComparision_Rule_18() throws Exception {
		...
		.body("{\r\n" + 
				...
				"                    \"clientID\": \""+data.clientID_AddresCount()+"\"," + 
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			AddressToConsumerComparision_Rule_18();
		}
