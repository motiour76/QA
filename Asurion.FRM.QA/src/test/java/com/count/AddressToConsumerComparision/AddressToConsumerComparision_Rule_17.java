...
public class AddressToConsumerComparision_Rule_17 {
	...
	@Test
	public  void AddressToConsumerComparision_Rule_17() throws Exception {
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			AddressToConsumerComparision_Rule_17();
		}
