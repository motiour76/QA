...
public class AddressToConsumerComparision_Rule_12 {
	...
	@Test
	public  void AddressToConsumerComparision_Rule_12() throws Exception {
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			AddressToConsumerComparision_Rule_12();
		}
