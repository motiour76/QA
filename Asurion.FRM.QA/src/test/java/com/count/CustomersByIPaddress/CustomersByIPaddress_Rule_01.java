...
public class CustomersByIPaddress_Rule_01 {
	...
	@Test
	public  void CustomersByIPaddress_Rule_01() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	CustomersByIPaddress customersByIPaddress = new CustomersByIPaddress();
        	customersByIPaddress.CustomersByIPaddress(serviceRequestNbr);
