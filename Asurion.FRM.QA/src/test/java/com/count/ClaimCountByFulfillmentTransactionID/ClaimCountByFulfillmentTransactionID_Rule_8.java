...
public class ClaimCountByFulfillmentTransactionID_Rule_8 {
	...
	@Test
	public  void ClaimCountByFulfillmentTransactionID_Rule_1() throws Exception {
		...
		.body("{\r\n" + 
				...
				"                    \"clientID\": \""+data.clientID_AddresCount1()+"\"," + 
        ...
        if (counter == numberOfTimes) {
        	...
        	ClaimCountByFulfillmentTransactionID addressToConsumerComparison = new ClaimCountByFulfillmentTransactionID();
        	addressToConsumerComparison.ClaimCountByFulfillmentTransactionID(serviceRequestNbr);
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			ClaimCountByFulfillmentTransactionID_Rule_1();
		}
