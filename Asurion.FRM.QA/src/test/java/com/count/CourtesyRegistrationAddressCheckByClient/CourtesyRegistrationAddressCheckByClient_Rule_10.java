...
public class CourtesyRegistrationAddressCheckByClient_Rule_10 {
	...
	@Test
	public  void CourtesyRegistrationAddressCheckByClient_Rule_13() throws Exception {
		...
		.body("{\r\n" + 
				...
				"                                    \"programType\": \""+ data.program_Type_Blank()+"\"," + 
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			CourtesyRegistrationAddressCheckByClient_Rule_13();
		}
