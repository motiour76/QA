...
package com.count.CourtesyRegistrationAddressCheckByClient;
...
public class CourtesyRegistrationAddressCheckByClient_Rule_4 {
	...
	@Test
	public  void CourtesyRegistrationAddressCheckByClient_Rule_01() throws Exception {
		...
		.body("{\r\n" + 
				...
				"                    \"clientID\": \""+data.clientID_141043767()+"\"," + 
        ...
        if (counter == numberOfTimes) {
        	...
        	CourtesyRegistrationAddressCheckByClient courtesyRegistrationAddressCheckByClient = new CourtesyRegistrationAddressCheckByClient();
        	courtesyRegistrationAddressCheckByClient.CourtesyRegistrationAddressCheckByClient(serviceRequestNbr);
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			CourtesyRegistrationAddressCheckByClient_Rule_01();
		}
