package com.count.SalvageCommentsToAddress;
...
public class SalvageCommentsToAddress_Rule_01 {
	...
	@Test
	public  void SalvageCommentsToAddress_Rule_01() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	SalvageCommentsToAddress salvageCommentsToAddress = new SalvageCommentsToAddress();
        	salvageCommentsToAddress.SalvageCommentsToAddress(serviceRequestNbr);
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			SalvageCommentsToAddress_Rule_01();
		}
