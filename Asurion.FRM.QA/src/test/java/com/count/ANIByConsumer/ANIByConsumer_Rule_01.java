...
public class ANIByConsumer_Rule_01 {
	...
	@Test
	public  void ANIByConsumer_Rule_01() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	ANIByConsumer aNIByConsumer = new ANIByConsumer();
        	aNIByConsumer.ANIByConsumer(serviceRequestNbr);
