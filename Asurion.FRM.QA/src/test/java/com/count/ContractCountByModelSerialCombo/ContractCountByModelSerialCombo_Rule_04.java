...
public class ContractCountByModelSerialCombo_Rule_04 {
	...
	@Test
	public  void ContractCountByModelSerialCombo_Rule_04() throws Exception {
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			ContractCountByModelSerialCombo_Rule_04();
		}
