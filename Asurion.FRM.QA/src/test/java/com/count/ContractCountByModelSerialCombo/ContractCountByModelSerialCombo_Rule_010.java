package com.count.ContractCountByModelSerialCombo;
...
public class ContractCountByModelSerialCombo_Rule_010 {
	...
	@Test
	public  void ContractCountByModelSerialCombo_Rule_010() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	ContractCountByModelSerialCombo contractCountByModelSerialCombo = new ContractCountByModelSerialCombo();
        	contractCountByModelSerialCombo.ContractCountByModelSerialCombo(serviceRequestNbr);
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			ContractCountByModelSerialCombo_Rule_010();
		}
