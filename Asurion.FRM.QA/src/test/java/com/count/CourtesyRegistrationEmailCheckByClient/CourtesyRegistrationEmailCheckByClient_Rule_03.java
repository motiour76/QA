package com.count.CourtesyRegistrationEmailCheckByClient;
...
public class CourtesyRegistrationEmailCheckByClient_Rule_03 {
	...
	@Test
	public  void CourtesyRegistrationEmailCheckByClient_Rule_01() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	CourtesyRegistrationEmailCheckByClient courtesyRegistrationEmailCheckByClient = new CourtesyRegistrationEmailCheckByClient();
        	courtesyRegistrationEmailCheckByClient.CourtesyRegistrationEmailCheckByClient(serviceRequestNbr);
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			CourtesyRegistrationEmailCheckByClient_Rule_01();
		}
