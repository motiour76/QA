package com.count.PrimaryPhoneByTransactionNumber;
...
public class PrimaryPhoneByTransactionNumber_Rule_05 {
	...
	@Test
	public  void PrimaryPhoneByTransactionNumber_Rule_01() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	PrimaryPhoneByTransactionNumber primaryPhoneByTransactionNumber = new PrimaryPhoneByTransactionNumber();
        	primaryPhoneByTransactionNumber.PrimaryPhoneByTransactionNumber(serviceRequestNbr);
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			PrimaryPhoneByTransactionNumber_Rule_01();
		}
