...
public class PrimaryPhoneByTransactionNumber_Rule_17 {
	...
	@Test
	public  void PrimaryPhoneByTransactionNumber_Rule_17() throws Exception {
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			PrimaryPhoneByTransactionNumber_Rule_17();
		}
