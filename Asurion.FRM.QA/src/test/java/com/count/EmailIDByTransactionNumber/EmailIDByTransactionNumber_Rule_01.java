package com.count.EmailIDByTransactionNumber;
...
public class EmailIDByTransactionNumber_Rule_01 {
	...
	@Test
	public  void EmailIDByTransactionNumber_Rule_01() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	EmailIDByTransactionNumber emailIDByTransactionNumber = new EmailIDByTransactionNumber();
        	emailIDByTransactionNumber.EmailIDByTransactionNumber(serviceRequestNbr);
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			EmailIDByTransactionNumber_Rule_01();
		}
