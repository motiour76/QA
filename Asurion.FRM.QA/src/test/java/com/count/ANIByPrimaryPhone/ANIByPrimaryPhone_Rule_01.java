...
public class ANIByPrimaryPhone_Rule_01 {
	...
	@Test
	public  void ANIByPrimaryPhone_Rule_01() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	ANIByPrimaryPhone aNIByPrimaryPhone = new ANIByPrimaryPhone();
        	aNIByPrimaryPhone.ANIByPrimaryPhone(serviceRequestNbr);
