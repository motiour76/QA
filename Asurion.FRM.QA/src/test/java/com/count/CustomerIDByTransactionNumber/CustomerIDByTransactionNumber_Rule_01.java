package com.count.CustomerIDByTransactionNumber;
...
public class CustomerIDByTransactionNumber_Rule_01 {
	...
	@Test
	public  void CustomerIDByTransactionNumber_Rule_01() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	CustomerIDByTransactionNumber customerIDByTransactionNumber = new CustomerIDByTransactionNumber();
        	customerIDByTransactionNumber.CustomerIDByTransactionNumber(serviceRequestNbr);
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			CustomerIDByTransactionNumber_Rule_01();
		}
