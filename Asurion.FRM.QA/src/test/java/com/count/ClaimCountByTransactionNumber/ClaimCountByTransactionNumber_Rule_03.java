...
public class ClaimCountByTransactionNumber_Rule_03 {
	...
	public  void ClaimCountByTransactionNumber_Rule_01() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	ClaimCountByTransactionNumber claimCountByTransactionNumber = new ClaimCountByTransactionNumber();
        	claimCountByTransactionNumber.ClaimCountByTransactionNumber(serviceRequestNbr);
