package com.count.AddressToEmailComparison;
...
public class AddressToEmailComparison_Rule_01 {
	...
	@Test
	public  void AddressToEmailComparison_Rule_01() throws Exception {
		...
		.body("{\r\n" + 
				...
				"                                    \"programType\": \""+ data.program_Type_FEE_PLAN()+"\"," + 
        ...
        if (counter == numberOfTimes) {
        	...
        	AddressToEmailComparison addressToConsumerComparison = new AddressToEmailComparison();
        	addressToConsumerComparison.AddressToEmailComparison(serviceRequestNbr);
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			AddressToEmailComparison_Rule_01();
		}
