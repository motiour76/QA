...
public class ClaimCountByPEBOOverrideFlag_Rule_14 {
	...
	@Test
	public  void ClaimCountByPEBOOverrideFlag_Rule_14() throws Exception {
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			ClaimCountByPEBOOverrideFlag_Rule_14();
		}
