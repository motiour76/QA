package com.count.ClaimCountByPEBOOverrideFlag;
...
public class ClaimCountByPEBOOverrideFlag_Rule_07 {
	...
	@Test
	public  void ClaimCountByPEBOOverrideFlag_Rule_01() throws Exception {
		...
		.body("{\r\n" + 
				...
				"                                    \"programType\": \""+ data.program_Type_WHOLE_WHOME()+"\"," + 
        ...
        if (counter == numberOfTimes) {
        	...
        	ClaimCountByPEBOOverrideFlag claimCountByPEBOOverrideFlag = new ClaimCountByPEBOOverrideFlag();
        	claimCountByPEBOOverrideFlag.ClaimCountByPEBOOverrideFlag(serviceRequestNbr);
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			ClaimCountByPEBOOverrideFlag_Rule_01();
		}
