...
public class SalvageCommentsToWebID_Rule_01 {
	...
	@Test
	public  void SalvageCommentsToWebID_Rule_01() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	SalvageCommentsToWebID salvageCommentsToWebID = new SalvageCommentsToWebID();
        	salvageCommentsToWebID.SalvageCommentsToWebID(serviceRequestNbr);
	...
	public  void callInLoop() throws Exception {
		...
		if (counter != numberOfTimes && counter < numberOfTimes) {
			SalvageCommentsToWebID_Rule_01();
		}
