...
package com.count.AddressMatch;
...
public class AddressMatch_Rule_19 {
	
	public int counter = 0;
	public int numberOfTimes =11;
	public String serviceRequestNbr;
	
	

	@Test
	public  void AddressMatch_Rule_19() throws Exception {
        ...
        if (counter == numberOfTimes) {
        	...
        	AddressMatch addressToConsumerComparison = new AddressMatch();
        	addressToConsumerComparison.AddressMatch(serviceRequestNbr);
