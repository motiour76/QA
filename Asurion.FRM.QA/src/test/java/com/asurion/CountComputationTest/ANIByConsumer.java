...
public class ANIByConsumer {
	...
	@Test
	public void ANIByConsumer() throws SQLException {
		...
		try {
			...
			myRs = myStmt.executeQuery("SELECT FRAUD_ACTION_CODE, DECISION_RULE_ID, DECISION_TABLE_NAME FROM QAFRMRTM.FRAUD_ACTION where SERVICE_REQUEST_NBR = '53123451234' and DECISION_TABLE_NAME = 'ANIByConsumer';");
			...
			while (myRs.next()) {
				...
				Assert.assertEquals(RuleName, "ANIByConsumer");
