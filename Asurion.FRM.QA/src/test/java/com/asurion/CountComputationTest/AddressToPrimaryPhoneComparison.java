...
public class AddressToPrimaryPhoneComparison {
	@Test
	public void AddressToPrimaryPhoneComparison() throws SQLException {
		...
		try {
			...
			myRs = myStmt.executeQuery("SELECT FRAUD_ACTION_CODE, DECISION_RULE_ID, DECISION_TABLE_NAME FROM QAFRMRTM.FRAUD_ACTION where SERVICE_REQUEST_NBR = '3123123'and DECISION_TABLE_NAME = 'AddressToPrimaryPhoneComparison';");
			...
			while (myRs.next()) {
				...
				Assert.assertEquals(RuleName, "AddressToPrimaryPhoneComparison");
