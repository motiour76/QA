...
public class ANIByGeoIDs {

	@Test
	public void ANIByGeoIDs() throws SQLException {
		...
		try {
			...
			myRs = myStmt.executeQuery("SELECT FRAUD_ACTION_CODE, DECISION_RULE_ID, DECISION_TABLE_NAME FROM QAFRMRTM.FRAUD_ACTION where SERVICE_REQUEST_NBR = '2721231123' and DECISION_TABLE_NAME = 'ANIByGeoIDs';");
			...
			while (myRs.next()) {
				...
				Assert.assertEquals(RuleName, "ANIByGeoIDs");
