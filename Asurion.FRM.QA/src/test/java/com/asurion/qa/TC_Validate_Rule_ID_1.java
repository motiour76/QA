...
public class TC_Validate_Rule_ID_1 {
	...
	String program_Type = "FEE PLAN";
	String receipt_Status_Code = "N";
	int client_Id = 6018553 ; 
	...
	@Test
	public void ASURION_RuleID_1_Paramater() {
		...
		ValidatableResponse response = given()
			  ...
			  //To generate number for date / sr number	    
