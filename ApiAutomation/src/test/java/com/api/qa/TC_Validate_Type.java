...
public class TC_Validate_Type {
	...
	public void validate_json_Service_Request_Type() {
		ValidatableResponse response =  given().contentType(ContentType.JSON)
				...
				.contentType(ContentType.JSON);
    	         String service_request_Id = response.extract().path("FRMCheckResp.attributes.type");
     	      
			    Assert.assertEquals(service_request_Id, "www.tibco.com/be/ontology/Concepts/Response/FRMCheckResp");
	}
	...
	public void validate_json_RULE_Id() {
				...
				.then()
				.extract()
				.path("FRMCheckResp.RiskOutputs[3]");
				System.out.println(service_id);
		}
